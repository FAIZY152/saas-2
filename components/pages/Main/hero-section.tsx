      ...
      <div className="container mx-auto px-4 relative">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
            Transform your content creation and marketing with our cutting-edge
            AI tools. Generate stunning YouTube thumbnails, analyze trends, and
            create compelling video ads effortlessly.
          </p>
