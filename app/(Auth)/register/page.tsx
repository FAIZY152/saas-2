...
import { ArrowRight, Bot, Sparkles, Eye, EyeOff } from "lucide-react";
        ...
        <Card className="backdrop-blur-sm bg-white/80 dark:bg-slate-800/90 border-0 shadow-2xl shadow-blue-500/10 dark:shadow-blue-500/5">
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription className="text-slate-600 dark:text-slate-300">
              Sign up to access your AI-powered dashboard
            </CardDescription>
          </CardHeader>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    className="h-12 pr-12 border-slate-200 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100 focus:border-blue-500 focus:ring-blue-500/20"
