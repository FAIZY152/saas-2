      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="text-muted-foreground">
            Create compelling video advertisements with AI-powered scripts,
            avatars, and voices.
          </p>
        </div>
            ...
            <div className="grid lg:grid-cols-3 gap-6">
              <Card className="lg:col-span-2">
                <CardHeader>
                  ...
                  <CardDescription>
                    Create compelling ad scripts tailored to your audience
                  </CardDescription>
                </CardHeader>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Quick start with proven templates
                  </CardDescription>
                </CardHeader>
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Upload your product images or brand assets
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Choose from our stock image collection
                  </CardDescription>
                </CardHeader>
                <CardContent>
          ...
          <TabsContent value="avatar" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Select from diverse AI avatars to present your ads
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="voice" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Choose natural-sounding voices in multiple languages and
                  accents
                </CardDescription>
              </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Recently created video advertisements
            </CardDescription>
          </CardHeader>
          <CardContent>
